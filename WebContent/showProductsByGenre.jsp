...
<html>
	...
	<div id="header">
		...
		<h1 class="l-heading" style="text-align: center;">
			<span class="text-primary"><%=(String)request.getParameter("genre") %></span>
		</h1>
		...
		<div id="bookCards">
				...
				<% String genreType = (String)request.getParameter("genre");
				if(genreType!=null)
				{
					String sqlQuery = "select * from books_details inner join genres on books_details.genre_id=genres.genre_id WHERE genres.genre='"+genreType+"'";
					ResultSet rs1=Manager.fetchData(sqlQuery);
					while (rs1.next()) {
						%>
